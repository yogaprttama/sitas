...
<?php endif; ?>
			...
			<?php foreach($rows as $row): ?>
									<tr>
										...
										<td>
											<a href="<?php echo base_url("siswa/{$row->no_induk}"); ?>" style="color: black;"><?php echo $row->nama_siswa; ?></a>
										</td>
										<td><?php echo $row->jenis_kelamin; ?></td>
										<td><?php echo $row->alamat; ?></td>
										<td>
											<a href="<?php echo base_url("edit/siswa/{$row->no_induk}"); ?>">
												<span class="glyphicon glyphicon-edit"></span>
											</a>
										</td>
										<td>
											<a href="<?php echo base_url("delete/siswa/{$row->no_induk}"); ?>">

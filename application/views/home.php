					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown">							
							<a href="#" class="dropdown-toggle avatar" data-toggle="dropdown" role="button" aria-expanded="false">
								<img src="<?php echo base_url('assets/img/avatar.png'); ?>" class="img-circle" alt="avatar" width="30" height="30"> <?php echo $this->session->userdata('user'); ?> <span class="caret"></span>
							</a>
...
<?php if($this->session->flashdata('loginSukses')): ?>
			<div class="alert alert-success alert-dismissible">
				...
				<?php echo $this->session->flashdata('loginSukses'); ?>
